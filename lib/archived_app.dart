...
class ArchivedAppScreen extends StatefulWidget {
  const ArchivedAppScreen({super.key});

  @override
  State<ArchivedAppScreen> createState() => _ArchivedAppScreenState();
}

class _ArchivedAppScreenState extends State<ArchivedAppScreen> {
  @override
